                            ...
                            <div className="content-data">
                                ...
                                <div className="footer-section third-section">
                                    ...
                                    <div className="address">
                                        ...
                                        <div className="data1">
                                            <label className="labeldata">RECEPTION:</label>
                                            <div className="contentdata">+91 92277 11855/56</div>
                                        </div>
                                        <div className="data1">
                                            <label className="labeldata">APPOITMENT:</label>
                                            <div className="contentdata">+91 92277 11854</div>
                                        </div>
                                        <div className="data1">
                                            <label className="labeldata">EMERGENCY:</label>
                                            <div className="contentdata">+91 92277 11852 </div>
                                        </div>
                                        <div className="data1">
                                            <label className="labeldata">EMAI:</label>
